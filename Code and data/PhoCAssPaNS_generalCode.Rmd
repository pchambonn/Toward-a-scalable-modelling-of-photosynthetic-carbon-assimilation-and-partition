...
# The order of the parameters for each line is as follows:
  ...
  # lambda_CHO <=> 15
  # µ_max_exp <=> 16
  # alpha_qp_char_cellDiv <=> 17
  # beta_qp_char_cellDiv <=> 18
  # q_CHO_cell_max_global <=> 19
  # p_L_cell_max <=> 20
  # I0 <=> 21
  # Volume_change <=> 22
  # alpha_PI <=> 23
...
table_parameters = matrix(data = c(200	,	100	,	400	,
                                   50	,	25	,	100	,
                                   0.0556	,	0.054181633	,	0.057018367	,
...
table_results_SA <- matrix(NA, nrow = 49, ncol = 6)
...
for(i_sensitivity in (1:49)){
  ...
  n_iter = local_parameters_list[1] # number of iterations
  n_mesh = local_parameters_list[2] # mesh subdivision for discrete modelling of E-flasks
  dt = 16/n_iter # time step (day)
  simulation_df <- data.frame(time = seq(0,n_iter*dt,dt))
  ...
  d_reactor = local_parameters_list[3]
  r_reactor = local_parameters_list[4]
  angle_eflask = local_parameters_list[5]
  ...
  Y_CHO_O2 <- 4/32*180/24
  Y_C_CHO <- 0.439
  Y_X_C <-  local_parameters_list[6]
  Y_C_L <- local_parameters_list[7]
  Y_C_P <- local_parameters_list[8]
  ...
  lambda_decay = local_parameters_list[9]
  Pm_0_exp = local_parameters_list[10]
  cnRatio_char = local_parameters_list[11]
  gamma_Pm = local_parameters_list[12]
  sigma_max = local_parameters_list[13]
  K_qP = local_parameters_list[14]
  lambda_CHO = local_parameters_list[15]
  µ_max_exp = local_parameters_list[16]
  alpha_qp_char_cellDiv = local_parameters_list[17]
  beta_qp_char_cellDiv = local_parameters_list[18]
  q_CHO_cell_max_global = local_parameters_list[19]
  p_L_cell_max = local_parameters_list[20]
  ...
  V_reactor_0_table <- c(V_reactor_0,rep(NA,nrow(simulation_df)-1))
  matrix_volume_change <- local_parameters_list[22]*
  ...
  alpha_PI = local_parameters_list[23]
  K2_mass = local_parameters_list[24]
...
if (option_run_local_SA == 1){
  table_results_SA <- read.csv(file = paste(localPath,"/Data files/Sensitivity analysis_final.csv"),
  sep = ";")
