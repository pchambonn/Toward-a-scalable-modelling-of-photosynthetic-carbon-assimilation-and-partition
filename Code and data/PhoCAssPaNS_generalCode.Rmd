...
R2_lipids_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
R2_lipids_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(R2_lipids_base_vector_sorted[,2],rep(R2_lipids_base_value,22)),
  x_max = c(rep(R2_lipids_base_value,22),R2_lipids_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Lipids",44),
  base_value = rep(R2_lipids_base_value,44)
)
...
R2_biomass_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
R2_biomass_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(R2_biomass_base_vector_sorted[,2],rep(R2_biomass_base_value,22)),
  x_max = c(rep(R2_biomass_base_value,22),R2_biomass_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Biomass",44),
  base_value = rep(R2_biomass_base_value,44)
)
...
R2_CHO_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
R2_CHO_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(R2_CHO_base_vector_sorted[,2],rep(R2_CHO_base_value,22)),
  x_max = c(rep(R2_CHO_base_value,22),R2_CHO_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Carbohydrates",44),
  base_value = rep(R2_CHO_base_value,44)
)
...
RMSE_lipids_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
RMSE_lipids_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(RMSE_lipids_base_vector_sorted[,2],rep(RMSE_lipids_base_value,22)),
  x_max = c(rep(RMSE_lipids_base_value,22),RMSE_lipids_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Lipids",44),
  base_value = rep(RMSE_lipids_base_value,44)
)
...
RMSE_biomass_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
RMSE_biomass_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(RMSE_biomass_base_vector_sorted[,2],rep(RMSE_biomass_base_value,22)),
  x_max = c(rep(RMSE_biomass_base_value,22),RMSE_biomass_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Biomass",44),
  base_value = rep(RMSE_biomass_base_value,44)
)
...
RMSE_CHO_base_vector_1 <- matrix(NA,nrow = 22,ncol = 4)
...
RMSE_CHO_df <- data.frame(
  y_min = rep(seq(1,22,1) - width/2,2),
  y_max = rep(seq(1,22,1) + width/2,2),
  x_min = c(RMSE_CHO_base_vector_sorted[,2],rep(RMSE_CHO_base_value,22)),
  x_max = c(rep(RMSE_CHO_base_value,22),RMSE_CHO_base_vector_sorted[,3]),
  fillValue = c(rep("Negative error",22),rep("Positive error",22)),
  facetValue = rep("Carbohydrates",44),
  base_value = rep(RMSE_CHO_base_value,44)
)
