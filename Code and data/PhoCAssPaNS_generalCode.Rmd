...
results_lustulia <- read_excel(paste(localPath,"/Data files/Results_Lustulia.xlsx",sep=""), sheet = "Feuil1", col_names = TRUE, n_max = Inf, skip = 2)
...
reactor_depth <- results_lustulia$`Reactor depth (m)`
### Volume of the reactor(mL) 
reactor_volume<- results_lustulia$`Reactor volume (mL)`
### Volume sampled at each day of sampling
sampled_volume <- results_lustulia$`Volume sampled`

# Data classification: factor vectors aiming at classifying the 3 concentration and the 3 light are created
concentration_class = as.factor(results_lustulia$Concentration)
light_class = as.factor(results_lustulia$Light)
...
dry_weight = rowMeans(cbind(results_lustulia$DW1,results_lustulia$DW2),na.rm = TRUE)
...
cell_count = rowMeans(cbind(results_lustulia$`Cell count 1`,results_lustulia$`Cell count 2`)*results_lustulia$`Dilution factor cell count`,na.rm = TRUE)
...
cell_size_d10 = results_lustulia$D10
### 25 percentile of cell diameter
cell_size_d25 = results_lustulia$D25
### Median cell diameter
cell_size_d50 = results_lustulia$D50
### 75 percentile of cell diameter
cell_size_d75 = results_lustulia$D75
### 90 percentile of cell diameter
cell_size_d90 = results_lustulia$D90
### Mean cell diameter
cell_size_dmean = results_lustulia$Dmean

# Broth optical properties
## Absorbance for the wavelength 880 nm, 683 nm, 483 nm
abs_880 = results_lustulia$`Dilution factor OD`*results_lustulia$`Abs 880 nm`
abs_683 = results_lustulia$`Dilution factor OD`*results_lustulia$`Abs 683 nm`
abs_483 = results_lustulia$`Dilution factor OD`*results_lustulia$`Abs 483 nm`
...
dilution_factor_TOC <- results_lustulia$`Dilution factor test TOC`
...
toc_specific = results_lustulia$TC/(dry_weight/results_lustulia$`Dilution factor test TOC`*1000)
tn_specific = results_lustulia$TN/(dry_weight/results_lustulia$`Dilution factor test TOC`*1000)
...
toc_cell_specific = results_lustulia$TC*results_lustulia$`Dilution factor test TOC`/1000/(cell_count*1000)
tn_cell_specific = results_lustulia$TN*results_lustulia$`Dilution factor test TOC`/1000/(cell_count*1000)
...
total_chla <- 12.19*results_lustulia$A_665-3.45*results_lustulia$`A _649`
total_chlb <- 21.99*results_lustulia$`A _649` - 5.32*results_lustulia$A_665
total_carot <- (1000*results_lustulia$A_480 - 2.14*total_chla - 70.16*total_chlb)/220

## Pigment mass specific content (µg pigment/mg algae)
total_chla_specific_weight = total_chla*(results_lustulia$`Volume extraction (mL)`)/(results_lustulia$`Volume sampled (mL)`*dry_weight/results_lustulia$`Dilution factor chl`)
total_chlb_specific_weight = total_chlb*(results_lustulia$`Volume extraction (mL)`)/((results_lustulia$`Volume sampled (mL)`)*dry_weight/results_lustulia$`Dilution factor chl`)
total_carot_specific_weight= total_carot*(results_lustulia$`Volume extraction (mL)`)/((results_lustulia$`Volume sampled (mL)`)*dry_weight/results_lustulia$`Dilution factor chl`)

### Pigment cell specific content (µg pigment/cell)
total_chla_cell_specific_weight = total_chla*(results_lustulia$`Volume extraction (mL)`)/((results_lustulia$`Volume sampled (mL)`)*cell_count/results_lustulia$`Dilution factor chl`)
total_chlb_cell_specific_weight = total_chlb*(results_lustulia$`Volume extraction (mL)`)/((results_lustulia$`Volume sampled (mL)`)*cell_count/results_lustulia$`Dilution factor chl`)
total_carot_cell_specific_weight= total_carot*(results_lustulia$`Volume extraction (mL)`)/((results_lustulia$`Volume sampled (mL)`)*cell_count/results_lustulia$`Dilution factor chl`)


# Lipids content
## Total lipid in the microalgae specific to dryweight are computed as the average of duplicates measurements (g Lipids/g DW)
total_FAME_1 = results_lustulia$`Total FAME`
total_FAME_2 = results_lustulia$`Total FAME 2`
...
total_sugars_1 = 0.91*results_lustulia$`% 1 (g glucose/g dw)`
total_sugars_2 = 0.91*results_lustulia$`% 2 (g glucose/g dw)`
...
o2cell_test = as.numeric(!is.na(results_lustulia$`Dilution tested (Factor)`))
### Oxygen production under light conditions measured and error associated [95% CI] for the first and second measurement (g O2/s)
PO2_1 = results_lustulia$`Productivity 1`*V_cell*1000/60/1000 
PO2_1_error = 1.96*results_lustulia$`Error productivity 1`*V_cell*1000/60/1000 
PO2_2 = results_lustulia$`Productivity 2`*V_cell*1000/60/1000 
PO2_2_error = 1.96*results_lustulia$`Error productivity 2`*V_cell*1000/60/1000 
### Respiration rates in the dark measured and error associated [95% CI] for the first and second measurement (g O2/s)
Resp_1 = results_lustulia$`Respiration 1`*V_cell*1000/60/1000 
Resp_1_error = 1.96*results_lustulia$`Error respiration 1`*V_cell*1000/60/1000 
Resp_2 = results_lustulia$`Respiration 2`*V_cell*1000/60/1000 
Resp_2_error = 1.96*results_lustulia$`Error respiration 2`*V_cell*1000/60/1000
### Light intensity set in the software (µmol/m2/s)
I0_O2_cell_1 = results_lustulia$`Light intensity 1`
I0_O2_cell_2 = results_lustulia$`Light intensity 2`
### Dilution factor used for the test from the experimental broth
dilution_factor_O2_cell = results_lustulia$`Dilution tested (Factor)`
### Optical density measured for the photosynthetic test experimental broth (880 nm and 683 nm)
OD_880_O2_cell = results_lustulia$OD880
OD_683_O2_cell = results_lustulia$OD683


# Light data
### Light intensity effectively received in the reactor (µmol/m2/s)
light_intensity_reactor = results_lustulia$`Transmittance filter`*results_lustulia$`Light intensity (mumol/m2/s)`
...
total_light_received = results_lustulia$`Total light absorbed from the start` 
### Total light absorbed globally for the volume between two samplings (µmol photons)
light_absorbed_interval <- results_lustulia$`Light absorbed delta t` 
...
```{r Compilation in a data frame, echo = TRUE}

results_lustulia_df = data.frame(day = results_lustulia$Day , sample = results_lustulia$Sample , concentrationClass = concentration_class , lightClass = light_class, 
...
```{r A posteriori correction of data, echo = TRUE}

results_lustulia_df$totalChlaSpecificWeight[1:10] <- 36.43
results_lustulia_df$totalChlbSpecificWeight[1:10] <- 18.37
results_lustulia_df$totalCarotSpecificWeight[1:10] <- 6.67

results_lustulia_df$totalChlaCellSpecificWeight[1:10] <- 1.48*10^(-6)
results_lustulia_df$totalChlbCellSpecificWeight[1:10] <- 7.44*10^(-7)
results_lustulia_df$totalCarotCellSpecificWeight[1:10] <- 2.70*10^(-7)
```
...
for (i in 1:nrow(results_lustulia_df)){
  if (results_lustulia_df$o2CellTest[i] == 1){
    dryweight_O2cell = results_lustulia_df$dryWeight[i]/results_lustulia_df$dilutionFactorO2Cell[i]
    n_cell = results_lustulia_df$cellCount[i]*1000/results_lustulia_df$dilutionFactorO2Cell[i]*V_cell*1000
    if (i %in% seq(2,10,1)){
      dryweight_O2cell = results_lustulia_df$dryWeight[1]/results_lustulia_df$dilutionFactorO2Cell[1]
      n_cell = results_lustulia_df$cellCount[1]*1000/results_lustulia_df$dilutionFactorO2Cell[1]*V_cell*1000 
    }
...
results_lustulia_df$mAlgaeO2cell = m_algae_O2cell
results_lustulia_df$nAlgaeO2cell = n_algae_O2cell


results_lustulia_df$lambdaPhotoresp = -results_lustulia_df$Resp2/results_lustulia_df$mAlgaeO2cell
results_lustulia_df$lambdaDark = -results_lustulia_df$Resp1/results_lustulia_df$mAlgaeO2cell
...
sigma_683_cell = log(10)*(1/0.01)*results_lustulia_df$OD683O2Cell/(results_lustulia_df$nAlgaeO2cell/V_cell) #m2/cell
sigma_880_cell = log(10)*(1/0.01)*results_lustulia_df$OD880O2Cell/(results_lustulia_df$nAlgaeO2cell/V_cell) #m2/cell
sigma_683_mass = log(10)*(1/0.01)*results_lustulia_df$OD683O2Cell/(results_lustulia_df$mAlgaeO2cell/V_cell) #m2/g
sigma_880_mass = log(10)*(1/0.01)*results_lustulia_df$OD880O2Cell/(results_lustulia_df$mAlgaeO2cell/V_cell) #m2/g

# Implementation
results_lustulia_df$sigma683Cell <- sigma_683_cell
results_lustulia_df$sigma880Cell <- sigma_880_cell
results_lustulia_df$sigma683Mass <- sigma_683_mass
results_lustulia_df$sigma880Mass <- sigma_880_mass

```

### Light supply analysis

Total light intensity abosrbed, dry-weight or cell specific, is computed here (µmol/s/g DW or µmol/s/cell, respectively) assuming Beer-Lambert law in a cylindrical reactor.

```{r, echo = TRUE}

results_lustulia_df$averageLightDensityDryweight <-
  results_lustulia_df$I0Reactor/(results_lustulia_df$reactorDepth*results_lustulia_df$dryWeight*1000)*
  (1-exp(-results_lustulia_df$sigma683Mass*results_lustulia_df$dryWeight*1000*results_lustulia_df$reactorDepth))


results_lustulia_df$averageLightDensityCell <- 
  results_lustulia_df$I0Reactor/(results_lustulia_df$reactorDepth*results_lustulia_df$cellCount*10^6)*
  (1-exp(-results_lustulia_df$sigma683Mass*results_lustulia_df$dryWeight*1000*results_lustulia_df$reactorDepth))
...
Variables related to cell division are calculated and appended to the main data frame below. BEcause cell division is calculated based on consecutive data using Euler method, cell specific data or protein specific data will be normaised using interval-averaged data ("MidInterval" vectors).

```{r, echo = TRUE}
# Creation of mid interval data to compare growth rate with these quantities
## Cell count in the reactor
aux <- dplyr::lag(results_lustulia_df$cellCount,9)
results_lustulia_df$cellCountMidInterval = c(0.5*(results_lustulia_df$cellCount +  aux))

## Protein cell quota
aux <- dplyr::lag(results_lustulia_df$totalProteinCell,9)
results_lustulia_df$totalProteinCellMidInterval = c(0.5*(results_lustulia_df$totalProteinCell +  aux))

## Protein mass quota
aux <- dplyr::lag(results_lustulia_df$totalProtein,9)
results_lustulia_df$totalProteinMidInterval = c(0.5*(results_lustulia_df$totalProtein +  aux))

# Time derivative of cell count (dN/dt, cell/mL/d)
results_lustulia_df$divisionSpeed <- c(rep(NA,9),diff(results_lustulia_df$cellCount,9))/c(rep(NA,9),diff(results_lustulia_df$day,9))

# Cell division rate (1/N.dN/dt, 1/D)
results_lustulia_df$divisionRate <- 1/results_lustulia_df$cellCountMidInterval*results_lustulia_df$divisionSpeed
```
...
A second data frame is created which will serve to store the data generated in the analyis which are characteristic of a single reactor. This data frame will then serve for reactor specific analyses.

```{r, echo = TRUE, message=FALSE, warning=FALSE, results='hide'}

reactorLustulia_df <- 
  data.frame(concentrationClass = results_lustulia_df$concentrationClass[2:10],
             lightClass = results_lustulia_df$lightClass[2:10])

```

## Complementary parameters needed for the analysis

Parmeters not measured or determined in separate experiments needed for the analysis are referenced in the following block.
...
functionalPool_abs_error <- sqrt((totalProtein_rel_error*results_lustulia_df$totalProtein)^2 +
                               (totalFame_rel_error*results_lustulia_df$totalFAME)^2 +
                               (totalSugars_rel_error*results_lustulia_df$totalSugars)^2)


## Integration of errors calculated into the data frame, when the errors take the form of vectors
results_lustulia_df$totalFame_rel_error <- totalFame_rel_error
results_lustulia_df$totalFAMECell_rel_error <- totalFAMECell_rel_error
results_lustulia_df$totalSugars_rel_error <- totalSugars_rel_error
results_lustulia_df$totalSugarsCell_rel_error <- totalSugarsCell_rel_error
results_lustulia_df$functionalPool_abs_error <- functionalPool_abs_error

## Integration of errors directly for dark respiration
results_lustulia_df$lambdaPhotorespRelError = sqrt((results_lustulia_df$Resp2Error/results_lustulia_df$Resp2)^2 + dryweight_rel_error^2)
results_lustulia_df$lambdaDarkRelError = sqrt((results_lustulia_df$Resp1Error/results_lustulia_df$Resp1)^2 + dryweight_rel_error^2)
...
```{r , echo = TRUE, message=FALSE, warning=FALSE, results='hide'}
results_lustulia_df <- subset(results_lustulia_df, sample != "Mother")
```
...
```{r, echo = TRUE , fig.height=4.5,fig.width=6.5, message = FALSE , warning = FALSE}
...
Pm_fit_vector = rep(NA,nrow(results_lustulia_df))
Pm_min = rep(NA,nrow(results_lustulia_df))
Pm_max = rep(NA,nrow(results_lustulia_df))

# Loop of the determination
for (iexp in 1:nrow(results_lustulia_df)){
  ...
  if ((is.na(results_lustulia_df$dilutionFactorO2Cell[iexp]) == 0) &
      (is.na(results_lustulia_df$I0O2Cell2[iexp]) == 0)){
...
results_lustulia_df$PmMass <- Pm_fit_vector
results_lustulia_df$PmMassMin <- Pm_min
results_lustulia_df$PmMassMax <- Pm_max
...
Reactor and biomass specific light intensity absorbed is computed as the averaged value over the full experiment for each experiment, and saved in the per reactor data frame reactorLustulia_df (µmol/s/g-DW and µmol/s/cell)
...
for (i_concentration in (1:3)){
  for (j_light in (1:3)){
    ...
    data_reduced <- subset(results_lustulia_df, concentrationClass == concentrationClassList[i_concentration])
...
reactorLustulia_df$lightDensity = lightDensity
reactorLustulia_df$lightDensityStd = lightDensity_std
reactorLustulia_df$lightDensityCell = lightDensityCell
reactorLustulia_df$lightDensityCell_std = lightDensityCell_std
...
carbon_fixed_exp <- results_lustulia_df$tocSpecific*results_lustulia_df$dryWeight
## Experimental total carbon fixed as carbohydrates (g C-CHO/L)
carbon_fixed_CHO_exp <- Y_C_CHO*results_lustulia_df$totalSugars*results_lustulia_df$dryWeight
## Experimental total carbon fixed as proteins (g C-proteins/L)
carbon_fixed_proteins_exp <- Y_C_P*results_lustulia_df$tnSpecific*factor_protein*results_lustulia_df$dryWeight
## Experimental total carbon fixed as lipids (g C-lipids/L)
carbon_fixed_lipids_exp <- Y_C_L*results_lustulia_df$totalFAME*results_lustulia_df$dryWeight
...
results_lustulia_df$carbonFixedExp <- carbon_fixed_exp
results_lustulia_df$carbonFixedCHOExp <- carbon_fixed_CHO_exp
results_lustulia_df$carbonFixedProteinsExp <- carbon_fixed_proteins_exp
results_lustulia_df$carbonFixedLipidsExp <- carbon_fixed_lipids_exp
results_lustulia_df$carbonFunctional <- carbon_functional

# Uncertainty analysis
## All uncertainty values are computed from error propagation analysis
carbonFixedCHOExp_rel_error <- sqrt(Y_C_CHO_rel_error^2 + 
                                      results_lustulia_df$totalSugars_rel_error^2 +
...
carbonFixedLipidsExp_rel_error <-
  sqrt(Y_C_L_rel_error^2 + 
         results_lustulia_df$totalFame_rel_error^2 +
         dryweight_rel_error^2)
...
## Appending data to the central data frame
results_lustulia_df$carbonFixedCHOExp_rel_error <- carbonFixedCHOExp_rel_error
results_lustulia_df$carbonFixedProteinsExp_rel_error  <- carbonFixedProteinsExp_rel_error
results_lustulia_df$carbonFixedLipidsExp_rel_error <-  carbonFixedLipidsExp_rel_error
results_lustulia_df$carbonFunctional_rel_error  <- carbonFunctional_rel_error
...
```{r , echo = TRUE, message=FALSE, warning=FALSE, results='hide'}
shape_factor = factor(results_lustulia_df$sample)
# Color factor
color_factor = factor(results_lustulia_df$lightClass, levels = c("25%","50%","100%"))
results_lustulia_df$lightClass <- color_factor

color_factor = factor(reactorLustulia_df$lightClass, levels = c("25%","50%","100%"))
reactorLustulia_df$lightClass <- color_factor

```

## Light supply analysis

```{r, echo = TRUE, fig.width=6, fig.height=4.2}

plot_lightdensity_a <-
  ggplot(data = results_lustulia_df,
...
plot_lightdensity_b <- ggplot(data = results_lustulia_df,
...
```{r echo = TRUE, message=FALSE, warning=FALSE, fig.height=4.5,fig.width=6, results='hide'}
...
```{r, ,fig.height=4.5,fig.width=5, echo = TRUE, warning=FALSE}
plot_biomass_a
```
...
plot_biomass_b <- ggplot(data = results_lustulia_df,
...
```{r, echo = TRUE,fig.height=4.5,fig.width=6.5, warning=FALSE}
plot_biomass_b
...
plot_chla_total <- ggplot(data = results_lustulia_df,
...
plot_chlb_total <- ggplot(data = results_lustulia_df,
...
plot_carot_total <- ggplot(data = results_lustulia_df,
...
```{r,  echo = TRUE , fig.height=5 , fig.width=17 , warning=FALSE}
plot_pigment_total
```

### Final plot
```{r, echo = TRUE, fig.width = 16, fig.height = 9}
...
plot_Pm_tern <- ggtern(data = subset(results_lustulia_df,PmMass < 1),
...
plot_photoRepsiration_tern <- ggtern(data = results_lustulia_df,
                                     aes(y=totalFAME,x=totalSugars,z=tnSpecific*factor_protein)) + 
  geom_errorbarL(aes(Lmin = totalSugars*(1 - totalSugars_rel_error), Lmax = totalSugars*(1 + totalSugars_rel_error)), width = 2, color = "black") +
  geom_errorbarR(aes(Rmin = totalProtein*(1 - totalProtein_rel_error), Rmax = totalProtein*(1 + totalProtein_rel_error)), width = 2, color = "black") +
  geom_errorbarT(aes(Tmin = totalFAME*(1 - totalFame_rel_error), Tmax = totalFAME*(1 + totalFame_rel_error)), width = 2, color = "black") +
...
results_lustulia_df$lambdaDark[which(results_lustulia_df$lambdaDark < 0)] <- NA

plot_darkRespiration_tern <-  ggtern(data = results_lustulia_df,
                                     aes(y=totalFAME,x=totalSugars,z=tnSpecific*factor_protein)) + 
  geom_errorbarL(aes(Lmin = totalSugars*(1 - totalSugars_rel_error), Lmax = totalSugars*(1 + totalSugars_rel_error)), width = 2, color = "black") +
  geom_errorbarR(aes(Rmin = totalProtein*(1 - totalProtein_rel_error), Rmax = totalProtein*(1 + totalProtein_rel_error)), width = 2, color = "black") +
  geom_errorbarT(aes(Tmin = totalFAME*(1 - totalFame_rel_error), Tmax = totalFAME*(1 + totalFame_rel_error)), width = 2, color = "black") +
...
max(results_lustulia_df$PmMass,na.rm = TRUE)/min(results_lustulia_df$PmMass,na.rm = TRUE)
```
...
```{r, echo=TRUE,warning=FALSE}
# Data minor transfo
functional_pool = (1 - (results_lustulia_df$totalFAME + results_lustulia_df$totalSugars + results_lustulia_df$totalProtein))
functional_pool[functional_pool < 0 ] <- 0

sample = c(results_lustulia_df$sample,results_lustulia_df$sample,results_lustulia_df$sample,results_lustulia_df$sample)
category = c(rep("Lipids",length(results_lustulia_df$totalFAME)),rep("Carbohydrates",length(results_lustulia_df$totalSugars)),rep("Proteins",length(results_lustulia_df$totalProtein)),rep("Functional compartment",length(functional_pool)))
data_quota = data.frame(Sample = sample, 
                        Quotas = c(results_lustulia_df$totalFAME,results_lustulia_df$totalSugars, results_lustulia_df$totalProtein,functional_pool), 
                        Day = c(results_lustulia_df$day,results_lustulia_df$day,results_lustulia_df$day,results_lustulia_df$day),
...
results_lustulia_df$functionalPool <- functional_pool
...
q_prot_min <- 0.99*min(results_lustulia_df$totalProtein,na.rm = TRUE) 
...
reactorLustulia_df$protDegradationRate <- -prot_degradation_rate
## Relative error on protein degradation rate (%, IC-95%)
reactorLustulia_df$protDegradationRate_rel_error <- abs(1.96*prot_degradation_rate_std/prot_degradation_rate)

# Ploting of the results
ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = protDegradationRate, colour = lightClass,shape = concentrationClass)) +
...
ggplot(data = reactorLustulia_df,aes(x = lightDensityCell,y = protDegradationRate, colour = lightClass,shape = concentrationClass)) +
  geom_point(size = 3,stroke = 1.25) +
...
lm(data = reactorLustulia_df, protDegradationRate ~ lightDensity)
summary(lm(data = reactorLustulia_df, protDegradationRate ~ lightDensity))
...
reactorLustulia_df$globalProtDegradationRate <- -global_prot_degradation_rate
reactorLustulia_df$globalProtDegradationRate_rel_error <- abs(1.96*global_prot_degradation_rate_std/global_prot_degradation_rate)

# Plotting the results
ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = globalProtDegradationRate,
...
ggplot(data = reactorLustulia_df,aes(x = lightDensityCell,y = globalProtDegradationRate, colour = lightClass,shape = concentrationClass)) +
  geom_point(size = 3,stroke = 1.25) +
  geom_errorbarh(aes(xmin = (lightDensityCell -1.96*lightDensityCell_std), xmax = (lightDensityCell + 1.96*lightDensityCell_std)),
                stroke = 1.25, height = 0.00125) +
  geom_errorbar(aes(ymin = globalProtDegradationRate*(1 - globalProtDegradationRate_rel_error), 
...
lm(data = reactorLustulia_df, globalProtDegradationRate ~ lightDensity)
summary(lm(data = reactorLustulia_df, globalProtDegradationRate ~ lightDensity))
...
max(results_lustulia_df$totalSugars,na.rm = TRUE)
results_lustulia_df$totalSugars_rel_error[which(results_lustulia_df$totalSugars == max(results_lustulia_df$totalSugars,na.rm = TRUE))]*max(results_lustulia_df$totalSugars,na.rm = TRUE)/1.96

# Max CHO cell quota and Standard error associated
max(results_lustulia_df$totalSugarsCell,na.rm = TRUE)
results_lustulia_df$totalSugarsCell_rel_error[which(results_lustulia_df$totalSugarsCell == max(results_lustulia_df$totalSugarsCell,na.rm = TRUE))]*max(results_lustulia_df$totalSugarsCell,na.rm = TRUE)/1.96
...
plot_total_content_FAME <- ggplot(data = results_lustulia_df,
...
plot_total_content_sugars <- ggplot(data = results_lustulia_df,
...
plot_total_content_proteins <- ggplot(data = results_lustulia_df,
...
plot_mass_content_FAME <- ggplot(data = results_lustulia_df,
...
plot_mass_content_sugars <- ggplot(data = results_lustulia_df,
...
plot_mass_content_proteins <- ggplot(data = results_lustulia_df,
...
```{r,  echo = TRUE , fig.height=14 , fig.width=17 , warning=FALSE}
plot_global_content_total
```
...
```{r,echo = TRUE, fig.width=6.5,fig.height=5}
...
reactorLustulia_df$functionalPoolLast <- functional_pool_last
reactorLustulia_df$functionalPool_abs_errorLast <- functionalPool_abs_error_last

# Plot of the results
ggplot(data = reactorLustulia_df, aes(x = lightDensity, y = functionalPoolLast, colour = lightClass,shape = concentrationClass)) +
  geom_point(size = 3,stroke = 1.25, position = position_dodge(width = 0.25)) +
...
lm_local <- lm(functionalPoolLast ~ lightDensity , data = reactorLustulia_df)
summary(lm_local)
...
```{r Modelling light distribution and O2 productivity in the e-flasks, echo = TRUE,warning=FALSE}
...
P_O2_gross <- rep(NA,nrow(results_lustulia_df))
P_O2_gross_min <- rep(NA,nrow(results_lustulia_df))
P_O2_gross_max <- rep(NA,nrow(results_lustulia_df))
...
for (iexp in (1:(nrow(results_lustulia_df)-9))){
  # Determination of the e-flaks broth depth (m)
  reactor_depth = results_lustulia_df$reactorDepth[iexp]
  ...
  if (is.na(reactor_depth) == 0){ # This condition is added to not perform the calculation on missing data
    ...
    I0_local <-results_lustulia_df$I0Reactor[iexp]
    ...
    sigma_local <- 1/2*(results_lustulia_df$sigma683Mass[iexp] + results_lustulia_df$sigma683Mass[iexp + 9])
    ## Cell concentration in the reactor (cell/m3)
    n_algae_local <- 1/2*(results_lustulia_df$cellCount[iexp] + results_lustulia_df$cellCount[iexp + 9])*10^6
    ## Dryweight concentration in the reactor (g/m3)
    x_algae_local <- 1/2*(results_lustulia_df$dryWeight[iexp] + results_lustulia_df$dryWeight[iexp + 9])*1000
    ## specific photosynthetic rate of O2 production (g O2/g DW/s)
    ### Central, minimal, and maximal values are computed
    PmMass_local <- 1/2*(results_lustulia_df$PmMass[iexp] + results_lustulia_df$PmMass[iexp + 9])
    PmMass_min_local <- 1/2*(results_lustulia_df$PmMassMin[iexp] + results_lustulia_df$PmMassMin[iexp + 9])
    PmMass_max_local <- 1/2*(results_lustulia_df$PmMassMax[iexp] + results_lustulia_df$PmMassMax[iexp + 9])
    ...
    P_O2_gross[iexp] <- sum(P_O2_spec_local,na.rm = TRUE)/(results_lustulia_df$reactorVolume[iexp]/1000) 
    
    P_O2_gross_min[iexp] <- sum(P_O2_spec_min_local,na.rm = TRUE)/(results_lustulia_df$reactorVolume[iexp]/1000) 
    
    P_O2_gross_max[iexp] <- sum(P_O2_spec_max_local,na.rm = TRUE)/(results_lustulia_df$reactorVolume[iexp]/1000) 
  }
...
Respiration_gross <- (results_lustulia_df$Resp1/results_lustulia_df$mAlgaeO2cell)*(results_lustulia_df$dryWeight)*24*3600
...
aux_carbon_fixed_gross_theo <- delta_carbon_fixed_CHO_gross_theo*diff(results_lustulia_df$day[1:length(results_lustulia_df$day)],9)

# Determination of gross functional carbon predicted to be fixed in biomass
## Creation of the vector storing the resutls
func_carbon_fixed_gross_theo <- rep(NA,nrow(results_lustulia_df))
## Initialisation based on measured value
func_carbon_fixed_gross_theo[1:9] <- results_lustulia_df$carbonFunctional[1:9]
...
for (i in 10:nrow(results_lustulia_df)){
...
aux_carbon_fixed_net_theo <- delta_carbon_fixed_CHO_net_theo*c(diff(results_lustulia_df$day[1:length(results_lustulia_df$day)],9),rep(0,9)) # gC/L
# Determination of net functional carbon predicted to be fixed in biomass
## Creation of the vector storing the resutls
carbon_fixed_net_theo <- rep(NA,nrow(results_lustulia_df))
## Initialisation based on measured value
carbon_fixed_net_theo[1:9] <- results_lustulia_df$carbonFunctional[1:9]
## Loop of determination:
...
aux_carbon_fixed_gross_theo_min <- delta_carbon_fixed_CHO_gross_theo_min*diff(results_lustulia_df$day[1:length(results_lustulia_df$day)],9)
func_carbon_fixed_gross_theo_min <- rep(NA,nrow(results_lustulia_df))
func_carbon_fixed_gross_theo_min[1:9] <- results_lustulia_df$carbonFunctional[1:9]
for (i in 10:nrow(results_lustulia_df)){
...
aux_carbon_fixed_gross_theo_max <- delta_carbon_fixed_CHO_gross_theo_max*diff(results_lustulia_df$day[1:length(results_lustulia_df$day)],9) # gC/L
func_carbon_fixed_gross_theo_max <- rep(NA,nrow(results_lustulia_df))
func_carbon_fixed_gross_theo_max[1:9] <- results_lustulia_df$carbonFunctional[1:9]
for (i in 10:nrow(results_lustulia_df)){
...
results_lustulia_df$functionalCarbonFixedGrossTheo <- func_carbon_fixed_gross_theo
results_lustulia_df$functionalCarbonFixedGrossTheoMin <- func_carbon_fixed_gross_theo_min
results_lustulia_df$functionalCarbonFixedGrossTheoMax <- func_carbon_fixed_gross_theo_max
results_lustulia_df$carbonFixedNetTheo <- carbon_fixed_net_theo

# Relative error associated 
results_lustulia_df$functionalCarbonFixedGrossTheo_rel_error <- 
...
```{r, echo = TRUE,warning=FALSE,fig.width=7,fig.height=5}

summary(lm(carbonFunctional ~ functionalCarbonFixedGrossTheo + 0, data = results_lustulia_df))
...
results_lustulia_df$specificCarbonFunctionalFixedGrossTheo <- 
  results_lustulia_df$functionalCarbonFixedGrossTheo/results_lustulia_df$dryWeight
# Relative error associated to this value is likewise computed (%)
results_lustulia_df$specificCarbonFunctionalFixedGrossTheo_rel_error <-
  sqrt(results_lustulia_df$functionalCarbonFixedGrossTheo_rel_error^2 + 
         dryweight_rel_error^2)

# The mass specific functional carbon fixed experimentally determined is determined (g C/g dw) 
results_lustulia_df$specificCarbonFunctional <- results_lustulia_df$carbonFunctional/results_lustulia_df$dryWeight
# Relative error is also determined (%)
results_lustulia_df$specificCarbonFunctional_rel_error <-
  sqrt(results_lustulia_df$carbonFunctional_rel_error^2 +
         dryweight_rel_error^2)
...
results_lustulia_df$specificCarbonRespirationLoss <-
  results_lustulia_df$specificCarbonFunctional - results_lustulia_df$specificCarbonFunctionalFixedGrossTheo
# Error associated is determined (absolute error, g C/g DW/d)
results_lustulia_df$specificCarbonRespirationLoss_abs_error <-
  sqrt((results_lustulia_df$specificCarbonFunctional*
          results_lustulia_df$specificCarbonFunctional_rel_error)^2  +
       (results_lustulia_df$specificCarbonFunctionalFixedGrossTheo*
          results_lustulia_df$specificCarbonFunctional_rel_error)^2)
...
reactorLustulia_df$specificDecayRate <- decay_rate_vector
reactorLustulia_df$specificDecayRate_rel_error <- 1.96*decay_rate_vector_IC/decay_rate_vector


# A global decay rate is determined as the average of all decay rate calculated in the 9 reactors

mean(reactorLustulia_df$specificDecayRate)
sd(reactorLustulia_df$specificDecayRate)/sqrt(9)

lambda_decay <- mean(reactorLustulia_df$specificDecayRate)

```

```{r ,fig.height=5,fig.width=7}
ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = -specificDecayRate, colour = lightClass,shape = concentrationClass)) +
  geom_point(size = 3,stroke = 1.25) +
...
ggplot(data = reactorLustulia_df,aes(x = lightDensityCell,y = specificDecayRate, colour = lightClass,shape = concentrationClass)) +
  geom_point() + 
  geom_errorbar(aes(ymin = (specificDecayRate*(1 - specificDecayRate_rel_error)), ymax = (specificDecayRate*(1 + specificDecayRate_rel_error))),
                stroke = 1.25) +
  geom_errorbarh(aes(xmin = (lightDensityCell -1.96*lightDensityCell_std), xmax = (lightDensityCell + 1.96*lightDensityCell_std)),
...
plot_carbon_biomass_LoCoLoLi <- ggplot(data = subset(results_lustulia_df, sample == "LoCoLoLi"),
...
plot_carbon_biomass_LoCoMeLi <- ggplot(data = subset(results_lustulia_df, sample == "LoCoMeLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_LoCoHiLi <- ggplot(data = subset(results_lustulia_df, sample == "LoCoHiLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_MeCoLoLi <- ggplot(data = subset(results_lustulia_df, sample == "MeCoLoLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_MeCoMeLi <- ggplot(data = subset(results_lustulia_df, sample == "MeCoMeLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_MeCoHiLi <- ggplot(data = subset(results_lustulia_df, sample == "MeCoHiLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_HiCoLoLi <- ggplot(data = subset(results_lustulia_df, sample == "HiCoLoLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_HiCoMeLi <- ggplot(data = subset(results_lustulia_df, sample == "HiCoMeLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
plot_carbon_biomass_HiCoHiLi <- ggplot(data = subset(results_lustulia_df, sample == "HiCoHiLi"),
     aes(x = day , y = specificCarbonRespirationLoss, color = sample, shape = sample)) +
  scale_shape_manual(values = 1:nlevels(shape_factor),na.translate = FALSE) +
  geom_point(size = 3, stroke = 1.25) +
  geom_errorbar(aes(ymin = specificCarbonRespirationLoss - specificCarbonRespirationLoss_abs_error,
...
lm_lustulia <- results_lustulia_df

# Lines with an absence of PmMass data are removed to avoid errors
lm_lustulia <- lm_lustulia[is.na(lm_lustulia$PmMass) == 0,]

# Non numeric data are removed to prevent errors
local_lm_lustulia <- lm_lustulia %>% select(where(is.numeric))
lm_lustulia <- local_lm_lustulia


# Spearman rank analysis
## Exctracting the number of columns
n_col = ncol(lm_lustulia)
...
for (i_row in (1:n_col)){
  for (j_col in (1:n_col)){
    ...
    local_test <- try(cor.test(x = as.double(lm_lustulia[,i_row]),
                           y = as.double(lm_lustulia[,j_col]),
                           method = "spearman"))
...
colnames(rho_spear_mat) <- colnames(lm_lustulia)
rownames(rho_spear_mat) <- colnames(lm_lustulia)
...
colnames_vector <- colnames(lm_lustulia)
...
ggplot(data = results_lustulia_df,aes(x = cnRatio , y = PmMass )) +
...
Pm_model_data = data.frame(PmMass = results_lustulia_df$PmMass,
                           cnRatio = results_lustulia_df$cnRatio,
                           PmMassMin = results_lustulia_df$PmMassMin,
                           PmMassMax = results_lustulia_df$PmMassMax,
                           log_PmMass_Norm = log(results_lustulia_df$PmMass/Pm_0_exp),
                           log_cnRatio = log(results_lustulia_df$cnRatio))
...
results_lustulia_df$PmMassModelResiduals <- results_lustulia_df$PmMass - Pm_0_exp*(results_lustulia_df$cnRatio/cnRatio_char)^(gamma_Pm)

SSR_Pm <- sum((results_lustulia_df$PmMass - results_lustulia_df$PmMassModelResiduals)^2,na.rm = TRUE)
SST_Pm <- sum((results_lustulia_df$PmMass - mean(results_lustulia_df$PmMass,na.rm = TRUE))^2,na.rm = TRUE)
...
# Preparation
lm_lustulia <- results_lustulia_df
lm_lustulia <- lm_lustulia[is.na(lm_lustulia$PmMassModelResiduals) == 0,]
local_lm_lustulia <- lm_lustulia %>% select(where(is.numeric))
lm_lustulia <- local_lm_lustulia
...
for (i_row in (1:n_col)){
  for (j_col in (1:n_col)){
    name_var_x <- colnames(lm_lustulia)[i_row]
    name_var_y <- colnames(lm_lustulia)[j_col]
    local_test <- try(cor.test(x = as.double(lm_lustulia[,i_row]),
                           y = as.double(lm_lustulia[,j_col]),
                           method = "spearman"))
    if (class(local_test) == "try-error"){
...
# Initialisation
lm_lustulia <- results_lustulia_df
lm_lustulia <- lm_lustulia[is.na(lm_lustulia$sigma683Mass) == 0,]
local_lm_lustulia <- lm_lustulia %>% select(where(is.numeric))
  lm_lustulia <- local_lm_lustulia
...
lm_sigma683_df <- data.frame(x = results_lustulia_df$sigma683Mass/results_lustulia_df$totalProtein, y = results_lustulia_df$sigma683Mass)
...
predicted_sigma683Mass <- sigma683Mass_max*
  results_lustulia_df$totalProtein/(K_sigma683Mass+results_lustulia_df$totalProtein)

SSR <- sum((predicted_sigma683Mass - results_lustulia_df$sigma683Mass)^2,na.rm = TRUE)
TSS <- sum((results_lustulia_df$sigma683Mass - mean(results_lustulia_df$sigma683Mass,na.rm = TRUE))^2,na.rm = TRUE)
R2 <- 1-SSR/TSS
R2
sum(is.na(results_lustulia_df$sigma683Mass) == 0)
...
predicted_sigma_local <- 
  sigma683Mass_max*results_lustulia_df$totalProtein/(K_sigma683Mass+results_lustulia_df$totalProtein)
residuals_sigma683 <- results_lustulia_df$sigma683Mass - predicted_sigma_local
## Appending the residuals to the global data frame
results_lustulia_df$residualsSigma683 <- residuals_sigma683

# Spearman rank coefficient analysis

lm_lustulia <- results_lustulia_df
lm_lustulia <- lm_lustulia[is.na(lm_lustulia$residualsSigma683) == 0,]
local_lm_lustulia <- lm_lustulia %>% select(where(is.numeric))
lm_lustulia <- local_lm_lustulia
...
local_lm_df <- data.frame(globalCHO =
                         results_lustulia_df$totalSugars*results_lustulia_df$dryWeight,
                       residualsSigma683 = results_lustulia_df$residualsSigma683)
...
predicted_sigma683Mass <- sigma683Mass_max*
  results_lustulia_df$totalProtein/(K_p+results_lustulia_df$totalProtein) - 
  lambda_CHO*results_lustulia_df$dryWeight*results_lustulia_df$totalSugars
  
results_lustulia_df$predictedSigma683Mass <- predicted_sigma683Mass
...
SSR <- sum((results_lustulia_df$predictedSigma683Mass - results_lustulia_df$sigma683Mass)^2,na.rm = TRUE)
TSS <- sum((results_lustulia_df$sigma683Mass - mean(results_lustulia_df$sigma683Mass,na.rm = TRUE))^2,na.rm = TRUE)
R2 <- 1-SSR/TSS
R2
sum(is.na(results_lustulia_df$sigma683Mass) == 0)
...
```{r, echo = TRUE, fig.height=5,fig.width=6.5}
# Determination of residuals
residuals_sigma683 <- results_lustulia_df$sigma683Mass - results_lustulia_df$predictedSigma683Mass
results_lustulia_df$residualsSigma683 <- residuals_sigma683
...
lm(residualsSigma683 ~ totalSugarsCell, results_lustulia_df)
...
local_lm_df <- data.frame(totalSugarsCell = 
                            results_lustulia_df$totalSugarsCell,
                       residualsSigma683 = results_lustulia_df$residualsSigma683)
...
predicted_sigma683Mass <- sigma683Mass_max*
  results_lustulia_df$totalProtein/(K_p+results_lustulia_df$totalProtein) - 
  lambda_CHO*results_lustulia_df$totalSugarsCell
...
predicted_sigma683Mass <- sigma683Mass_max*
  results_lustulia_df$totalProtein/(K_p+results_lustulia_df$totalProtein) -
  lambda_sugars*results_lustulia_df$totalSugarsCell
...
reactorLustulia_df$qCHOMax <- q_CHO_max_reactor

# Calculation of the global average and associated error
q_CHO_max_global <- mean(reactorLustulia_df$qCHOMax)
SE_qCHOMax <- sd(reactorLustulia_df$qCHOMax)/sqrt(9)
...
```{r ,fig.height=5,fig.width=7}
ggplot(data = reactorLustulia_df,aes(x = lightDensity , y = qCHOMax)) +
  geom_point(size = 3,stroke = 1.25) +
...
ggplot(data = reactorLustulia_df,aes(x = lightDensityCell,y = qCHOMax)) +
  geom_point(size = 3,stroke = 1.25,) +
  geom_errorbar(aes(ymin = qCHOMax - 1.96*SE_qCHOMax, ymax = qCHOMax + 1.96*SE_qCHOMax),
                stroke = 1.25) +
  geom_errorbarh(aes(xmin = (lightDensityCell -1.96*lightDensityCell_std), xmax = (lightDensityCell + 1.96*lightDensityCell_std)),
...
for (i_concentration in (1:3)){
  for (j_light in (1:3)){
    ...
    local_results <- subset(results_lustulia_df, concentrationClass == concentrationClassList[i_concentration])
    local_results <- subset(local_results, results_lustulia_df$lightClass == lightClassList[j_light])
...
reactorLustulia_df$µmDroop <- µ_max
reactorLustulia_df$µmDroopIC <- µ_max_IC
reactorLustulia_df$qMinDroop <- q_min
reactorLustulia_df$qMinDroopIC <- q_min_IC

mean(reactorLustulia_df$µmDroop)
mean(reactorLustulia_df$qMinDroop)
```
...
for (i_concentration in (1:3)){
  for (j_light in (1:3)){
    ...
    data_reduced <- subset(results_lustulia_df, concentrationClass == concentrationClassList[i_concentration])
    data_reduced <- subset(data_reduced, results_lustulia_df$lightClass == lightClassList[j_light])
...
reactorLustulia_df$µmExp <- µ_max
reactorLustulia_df$µmExp_rel_error <- µ_max_rel_error
reactorLustulia_df$qCriticExp <- q_critic
reactorLustulia_df$qCriticExp_rel_error <- q_critic_rel_error
...
µ_max_exp <- mean(reactorLustulia_df$µmExp)
µ_max_exp
sd(reactorLustulia_df$µmExp)/3

mean(reactorLustulia_df$qCriticExp)
sd(reactorLustulia_df$qCriticExp)/3
...
```{r, echo = TRUE, message=FALSE, warning=FALSE, results='hide', fig.width= 1.3*5.3, fig.height=1.3*4}

ggplot(data = reactorLustulia_df, aes(x = lightDensity, y = qCriticExp)) +
...
a <- lm(qCriticExp ~ lightDensity, data = reactorLustulia_df)
summary(a)
...
```{r, echo = TRUE, message=FALSE, warning=FALSE, results='hide', fig.width= 1.1*5.3, fig.height=1.1*4}


ggplot(data = reactorLustulia_df, aes(x = lightDensity, y = µmExp, colour = lightClass,shape = concentrationClass)) +
...
local_lm <- lm(dryWeight ~ carbonFunctional + 0, data = results_lustulia_df)
...
#-------------------------------------------------------------------------------
    ...
    data_comparison <- subset(results_lustulia_df , concentrationClass == concentrationClassList[i_concentration])
...
for (i_val in (1:nrow(results_lustulia_df))){
  
  if (results_lustulia_df$concentrationClass[i_val] == "0.1 g.L-1"){
    i_concentration <- 1
  }else{
    if (results_lustulia_df$concentrationClass[i_val] == "0.3 g.L-1"){
      i_concentration <- 2
    }else{
      i_concentration <- 3
    }
  ...
  if (results_lustulia_df$lightClass[i_val] == "25%"){
    j_light <- 1
  }else{
    if (results_lustulia_df$concentrationClass[i_val] == "0.3 g.L-1"){
      j_light <- 2
  ...
  results_lustulia_df$predicted_xAlgae[i_val] <- 
    local_simulation_df$xAlgae[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_nAlgae[i_val] <-
    local_simulation_df$nAlgae[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_P[i_val] <- 
    local_simulation_df$q_P[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_L[i_val] <- 
    local_simulation_df$q_L[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_CHO[i_val] <- 
    local_simulation_df$q_CHO[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_P_cell[i_val] <- 
    local_simulation_df$q_P_cell[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_L_cell[i_val] <- 
    local_simulation_df$q_L_cell[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_q_CHO_cell[i_val] <- 
    local_simulation_df$q_CHO_cell[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_cnRatio[i_val] <- 
    local_simulation_df$cnRatio[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_sigma683Mass[i_val] <- 
    local_simulation_df$sigma683Mass[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
  results_lustulia_df$predicted_Pm[i_val] <- 
    local_simulation_df$Pm[which(abs(local_simulation_df$time - results_lustulia_df$day[i_val]) == min(abs(local_simulation_df$time - results_lustulia_df$day[i_val])))]
...
validationPlot_dryweight <-
  ggplot(data = results_lustulia_df, aes(x = predicted_xAlgae, y = dryWeight)) +
    geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
    geom_errorbar(aes(ymin = dryWeight*(1 - dryweight_rel_error),
                      ymax = dryWeight*(1 + dryweight_rel_error)),
                  width = 0.05) +
...
validationPlot_cellCount <-
  ggplot(data = results_lustulia_df, aes(x = predicted_nAlgae, y = cellCount*1000)) +
    geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_P, y = totalProtein)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_CHO, y = totalSugars)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_L, y = totalFAME)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_P_cell, y = totalProteinCell)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
  geom_errorbar(aes(ymin = totalProteinCell*(1 - totalProteinCell_rel_error),
                    ymax = totalProteinCell*(1 + totalProteinCell_rel_error))) +
  geom_abline( slope = 1, intercept = 0,colour = "red", linewidth = 2 , linetype = "dashed") +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_CHO_cell, y = totalSugarsCell)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
  geom_errorbar(aes(ymin = totalSugarsCell*(1 - totalSugarsCell_rel_error),
                    ymax = totalSugarsCell*(1 + totalSugarsCell_rel_error))) +
  geom_abline( slope = 1, intercept = 0,colour = "red", linewidth = 2 , linetype = "dashed") +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_L_cell, y = totalFAMECell)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
  geom_errorbar(aes(ymin = totalFAMECell*(1 - totalFAMECell_rel_error),
                    ymax = totalFAMECell*(1 + totalFAMECell_rel_error))) +
  geom_abline( slope = 1, intercept = 0,colour = "red", linewidth = 2 , linetype = "dashed") +
...
ggplot(data = results_lustulia_df, aes(x = predicted_sigma683Mass, y = sigma683Mass)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
  geom_errorbar(aes(ymin = sigma683Mass*(1 - sigma_rel_error),
                    ymax = sigma683Mass*(1 + sigma_rel_error))) +
  geom_abline( slope = 1, intercept = 0,colour = "red", linewidth = 2 , linetype = "dashed") +
...
ggplot(data = results_lustulia_df, aes(x = predicted_Pm, y = PmMass)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
  geom_errorbar(aes(ymin = PmMassMin,
                    ymax = PmMassMax)) +
  geom_abline( slope = 1, intercept = 0,colour = "red", linewidth = 2 , linetype = "dashed") +
...
ggplot(data = results_lustulia_df, aes(x = predicted_cnRatio, y = cnRatio)) +
  geom_point(aes(color = lightClass, shape = concentrationClass), size = 3,stroke = 1.25) +
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_P + predicted_q_CHO + predicted_q_L ,
...
ggplot(data = results_lustulia_df, aes(x = predicted_q_P_cell*predicted_nAlgae, 
...
validationPlot_totalCHO <- 
  ggplot(data = results_lustulia_df, aes(x = predicted_q_CHO_cell*predicted_nAlgae, 
...
validationPlot_totalLipids <- 
  ggplot(data = results_lustulia_df, aes(x = predicted_q_L_cell*predicted_nAlgae,
...
SS_res <- sum((results_lustulia_df$dryWeight - results_lustulia_df$predicted_xAlgae)^2 , na.rm = TRUE)
SS_tot <- sum((results_lustulia_df$dryWeight - mean(results_lustulia_df$dryWeight,na.rm = TRUE))^2 , na.rm = TRUE)
R2_dryweight <- 1 - SS_res/SS_tot 

MRE_dryweight <- mean(abs((results_lustulia_df$dryWeight - results_lustulia_df$predicted_xAlgae)/results_lustulia_df$dryWeight),na.rm = TRUE)


# Global lipids

SS_res <- sum((results_lustulia_df$totalFAMECell*results_lustulia_df$cellCount*1000 -
                 results_lustulia_df$predicted_q_L_cell*results_lustulia_df$predicted_nAlgae)^2 ,
              na.rm = TRUE)
SS_tot <- sum((results_lustulia_df$totalFAMECell*results_lustulia_df$cellCount*1000 -
                 mean(results_lustulia_df$totalFAMECell*results_lustulia_df$cellCount*1000,
                      na.rm = TRUE))^2 ,
              na.rm = TRUE)
R2_lipids <- 1 - SS_res/SS_tot 
MRE_lipids <- mean(abs((results_lustulia_df$totalFAMECell*results_lustulia_df$cellCount*1000 -
                         results_lustulia_df$predicted_q_L_cell*results_lustulia_df$predicted_nAlgae)/
                     (results_lustulia_df$totalFAMECell*results_lustulia_df$cellCount*1000)),na.rm = TRUE)

# CHO

SS_res <- sum((results_lustulia_df$totalSugarsCell*results_lustulia_df$cellCount*1000 -
                 results_lustulia_df$predicted_q_CHO_cell*results_lustulia_df$predicted_nAlgae)^2 ,
              na.rm = TRUE)
SS_tot <- sum((results_lustulia_df$totalSugarsCell*results_lustulia_df$cellCount*1000 -
                 mean(results_lustulia_df$totalSugarsCell*results_lustulia_df$cellCount*1000,
                      na.rm = TRUE))^2 ,
              na.rm = TRUE)
R2_CHO <- 1 - SS_res/SS_tot 
MRE_CHO <- mean(abs((results_lustulia_df$totalSugarsCell*results_lustulia_df$cellCount*1000 -
                       results_lustulia_df$predicted_q_CHO_cell*results_lustulia_df$predicted_nAlgae)/
                      (results_lustulia_df$totalSugarsCell*results_lustulia_df$cellCount*1000)),na.rm = TRUE)

# Cell count

SS_res <- sum((results_lustulia_df$cellCount - results_lustulia_df$predicted_nAlgae/1000)^2 , na.rm = TRUE)
SS_tot <- sum((results_lustulia_df$cellCount - mean(results_lustulia_df$cellCount,na.rm = TRUE))^2 , na.rm = TRUE)
...
reactorLustulia_df$specChlaDegradationRate <- spec_chla_degradation_rate
reactorLustulia_df$specChlaDegradationRate_rel_error <- 
  abs(1.96*spec_chla_degradation_rate_std/spec_chla_degradation_rate)

reactorLustulia_df$specChlbDegradationRate <- spec_chlb_degradation_rate
reactorLustulia_df$specChlbDegradationRate_rel_error <- 
  abs(1.96*spec_chlb_degradation_rate_std/spec_chlb_degradation_rate)

reactorLustulia_df$specCarotDegradationRate <- spec_carot_degradation_rate
reactorLustulia_df$specCarotDegradationRate_rel_error <- 
  abs(1.96*spec_carot_degradation_rate_std/spec_carot_degradation_rate)

reactorLustulia_df$specTotalPigmentDegradationRate <- spec_totalPigment_degradation_rate
reactorLustulia_df$specTotalPigmentDegradationRate_rel_error <- 
  abs(1.96*spec_totalPigment_degradation_rate_std/spec_totalPigment_degradation_rate)

# Plot for chlorophyll-a
plot_chla_deg <- 
  ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = specChlaDegradationRate, colour = lightClass,shape = concentrationClass)) +
    geom_point(size = 3,stroke = 1.25) +
    geom_errorbarh(aes(xmin = (lightDensity -1.96*lightDensityStd), xmax = (lightDensity + 1.96*lightDensityStd)),
...
plot_chlb_deg <- 
  ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = specChlbDegradationRate, colour = lightClass,shape = concentrationClass)) +
    geom_point(size = 3,stroke = 1.25) +
    geom_errorbarh(aes(xmin = (lightDensity -1.96*lightDensityStd), xmax = (lightDensity + 1.96*lightDensityStd)),
...
plot_carot_deg <- 
  ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = specCarotDegradationRate, colour = lightClass,shape = concentrationClass)) +
    geom_point(size = 3,stroke = 1.25) +
    geom_errorbarh(aes(xmin = (lightDensity -1.96*lightDensityStd), xmax = (lightDensity + 1.96*lightDensityStd)),
                  stroke = 1.25, height = 0.005) +
...
plot_pigment_total_deg <- 
  ggplot(data = reactorLustulia_df,aes(x = lightDensity,y = specTotalPigmentDegradationRate, colour = lightClass,shape = concentrationClass)) +
    geom_point(size = 3,stroke = 1.25) +
    geom_errorbarh(aes(xmin = (lightDensity -1.96*lightDensityStd), xmax = (lightDensity + 1.96*lightDensityStd)),
